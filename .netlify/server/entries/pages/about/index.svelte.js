...
const About = (0, import_index_c7b10cea.c)(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>About | The Barn at Old Colony</title>`, ""}`, ""}

${(0, import_index_c7b10cea.v)(import_Container_9065ba37.C, "Container").$$render($$result, {}, {}, {
    default: () => {
      return `<h1>About</h1>

	<p>Our family has many memories of the old hay barn. Our three children loved climbing the tall,
	...
	<p>Unfortunately in 2004, we sold our happy holsteins like so many other dairy families had to do
		in our valley and eventually, we planted a beautiful almond orchard. Yet the old barn seemed
		hollow and alone.
	</p>
	<p>During the beginning of the pandemic, as our now adult-children began to trickle back home like
	...
	<p>Everyone helped make this venue a reality. Our eldest son,Cody, now a graphic designer. and his
	...
	<p>Well, we managed to survive and now we are really excited to share this historic, rustic bit of
	...
	<p>Old Colony Ranch began as The Hall Ranch in 1876. Prior to this date, the land was territory of
