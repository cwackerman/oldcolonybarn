...
const Root = (0, import_index_c7b10cea.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_c7b10cea.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_c7b10cea.v)(components[0] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_c7b10cea.v)(components[1] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${components[3] ? `${(0, import_index_c7b10cea.v)(components[2] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {
            default: () => {
              return `${components[4] ? `${(0, import_index_c7b10cea.v)(components[3] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_3 || {}), {}, {
                default: () => {
                  return `${(0, import_index_c7b10cea.v)(components[4] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_4 || {}), {}, {})}`;
                }
              })}` : `${(0, import_index_c7b10cea.v)(components[3] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_3 || {}), {}, {})}`}`;
            }
          })}` : `${(0, import_index_c7b10cea.v)(components[2] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`}`;
        }
      })}` : `${(0, import_index_c7b10cea.v)(components[1] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_c7b10cea.v)(components[0] || import_index_c7b10cea.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
